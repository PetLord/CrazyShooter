...
{
    private static string skyBoxPath = "Assets.Skybox.skybox.png";

    public SkyBox(GL gl, Shader shader) : base(new Mesh(gl, CreateSkyBox(gl, shader)))
    {
        Scale = new Vector3D<float>(25f, 25f, 25f);
    }
